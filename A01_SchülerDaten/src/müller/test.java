...
/** * * @author Maximilian * @version 17. Sep. 2015 */
...
public class SchülerDaten extends JPanel implements ActionListener {
	...
	public SchülerDaten() {
		...
		JLabel überschrift = new JLabel("Schülerdaten");
	...
	/** * * @param e * @since 17. Sep. 2015 */
	@Override
	public void actionPerformed(ActionEvent e) {
		final String[] month = { "Jänner", "Februar", "Märtz", "April", "Mai", "Juni", "Juli", "August", "September",
		...
		case "ok":
			...
			if (dateOk) {
				...
				System.out.println(dateGreg.get(GregorianCalendar.DAY_OF_MONTH) + "."
						+ month[dateGreg.get(GregorianCalendar.MONTH)] + "." + dateGreg.get(GregorianCalendar.YEAR));
